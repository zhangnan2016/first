...
Defines the Axios instance with token injection, the `R<T>` auto-unwrapping response interceptor, unauthorized redirect, and the route permission guard with dynamic routes.
